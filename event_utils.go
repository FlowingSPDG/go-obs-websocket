...
var eventMap = map[string]func() Event{
	...
	"VirtualCamStarted":             func() Event { return &VirtualCamStartedEvent{} },
	"VirtualCamStopped":             func() Event { return &VirtualCamStoppedEvent{} },
...
func derefEvent(e Event) Event {
	...
	case *RecordingResumedEvent:
		return *e
	case *VirtualCamStartedEvent:
		return *e
	case *VirtualCamStoppedEvent:
		return *e
